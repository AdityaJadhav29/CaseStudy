...
public class EmployeeTrainingController {
	...
	public ResponseEntity<List<TrainingModel>> Employee(@PathVariable int empId){
		return new ResponseEntity<List<TrainingModel>>((List<TrainingModel>)service.getallTrainingDetails(empId),HttpStatus.OK);
	}
